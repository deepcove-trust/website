        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MediaComponent_Media_ImageMediaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NavItemPages", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrueFalseAnswer = table.Column<int>(nullable: true),
                    Text = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaComponent_ImageMediaId",
                table: "MediaComponent",
                column: "ImageMediaId");

            migrationBuilder.CreateIndex(
                name: "IX_NavItemPages_NavItemId",
                table: "NavItemPages",
                column: "NavItemId");
